...
Le troisième objectif est la description des photos avec un vocabulaire formalisé afin de rendre interopérables ces descriptions. Ce vocabulaire est accessible par un menu circulaire à plusieurs niveaux que nous appelons un crible en référence aux différents travaux que nous avons menés dans ce domaine (@szoniecky2020).

Dans ce projet, nous avons défini deux cribles mais une infinité d'autres pourront être défini dans une nouvelle version de l'outil. Le premier crible reprend la classification proposée par l'UNESCO pour décrire les dangers auxquels le patrimoine immatériel est soumis :

![Cribles Unesco dangers patrimoine immatériel](images/localhost_cocult_tags.html.png){fig-align="center"}

Le second crible propose une catégorisation émotionnelle du document :

![Crible évaluation émotionnelle](images/localhost_cocult_tags.cribleEmo.png){fig-alt="Crible évaluation émotionnelle" fig-align="center"}
...
La vidéo suivante montre comment utiliser le prototype pour créer un itinéraire à partir de photos et décrire ces photos avec plusieurs cribles.